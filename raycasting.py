...
class RayCasting:
    ...
    def  get_objects_to_render(self):# prepara os objetos para renderização
        self.objects_to_render= []
        for ray, values in enumerate(self.ray_casting_result):
            ...
            if proj_height<HEIGHT:
                ...
                #se a parede for maior que a tela
    ...
    def ray_cast(self):
        ...
        for ray in range(NUM_RAYS):#loop de rios na deslocação do jogador, no caso vamos necessitar do seno e cosseno
            ...
            # Armazenar resultados do ray casting:
    ...
    def update(self):
        ...
        self.get_objects_to_render()# chama a função de objetos para renderização
